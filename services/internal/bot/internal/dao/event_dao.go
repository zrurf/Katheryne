...
func (d *EventDao) ListEventDeliveries(ctx context.Context, botID int64, convID int64, eventType, status string, page, size int32) ([]*bot.EventDeliveryItem, int64, error) {
	var total int64
	d.db.QueryRow(ctx,
	...
	var list []*bot.EventDeliveryItem
	for rows.Next() {
		var item bot.EventDeliveryItem
