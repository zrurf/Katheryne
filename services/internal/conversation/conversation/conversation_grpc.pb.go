...
const (
	...
	Conversation_UpdateGroupConvInfo_FullMethodName   = "/conversation.conversation/UpdateGroupConvInfo"
)
...
type ConversationClient interface {
	...
	UpdateGroupConvInfo(ctx context.Context, in *UpdateGroupConvInfoReq, opts ...grpc.CallOption) (*UpdateGroupConvInfoResp, error)
}
...
func (c *conversationClient) UpdateGroupConvInfo(ctx context.Context, in *UpdateGroupConvInfoReq, opts ...grpc.CallOption) (*UpdateGroupConvInfoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateGroupConvInfoResp)
	err := c.cc.Invoke(ctx, Conversation_UpdateGroupConvInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversationServer interface {
	...
	UpdateGroupConvInfo(context.Context, *UpdateGroupConvInfoReq) (*UpdateGroupConvInfoResp, error)
...
func (UnimplementedConversationServer) UpdateGroupConvInfo(context.Context, *UpdateGroupConvInfoReq) (*UpdateGroupConvInfoResp, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateGroupConvInfo not implemented")
}
...
func _Conversation_UpdateGroupConvInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateGroupConvInfoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationServer).UpdateGroupConvInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Conversation_UpdateGroupConvInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationServer).UpdateGroupConvInfo(ctx, req.(*UpdateGroupConvInfoReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Conversation_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateGroupConvInfo",
			Handler:    _Conversation_UpdateGroupConvInfo_Handler,
		},
	},
